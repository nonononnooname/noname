...
export default function AtqmPage() {
  return (
    <>
      {/* Ambient smoke behind the whole page. Section 02 (which has its own
          entropy field) is opaque and covers it; the hero and the other sections
          are transparent, so the smoke fills their space. */}
      <div
        aria-hidden
