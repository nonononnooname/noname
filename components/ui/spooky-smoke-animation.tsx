...
// Animated fbm-noise "smoke". The bright parts of the noise are tinted toward
// `smokeColor`, so the fog can carry a brand hue.
...
interface SmokeBackgroundProps {
  /** Hex color the smoke highlights are tinted toward. */
  smokeColor?: string;
  className?: string;
}
...
export function SmokeBackground({
  ...
  useEffect(() => {
    ...
    const renderer = new SmokeRenderer(canvas, gl);
